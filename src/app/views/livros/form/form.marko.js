...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casa-do-codigo$1.0.0/src/app/views/books/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  if (data.errosValidacao) {
    ...
    marko_forEach(data.errosValidacao, function(error) {
...
marko_template.meta = {
    id: "/casa-do-codigo$1.0.0/src/app/views/books/livros/form/form.marko",
    tags: [
